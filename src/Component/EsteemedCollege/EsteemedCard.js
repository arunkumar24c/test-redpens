    ...
    return (
        <>
            <div className=' my-5 py-4'>
                <p className='text-center mb-3 font-bold text-2xl md:text-4xl lg:text-4xl xl:text-4xl text-brnd-dark-blue'>TRP Admissions</p>
                <p className='text-center text-md  '>Business schools where our applicants have secured admissions</p>
