...
function ServiceComponent() {
    ...
    return (
        <>
            <div className='py-20 px-10 pb-[200px]  bg-[#F3F5f5] Container-wrapper'>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-md md:text-md lg:text-md xl:text-md  text-center'>Offered by experts to meet your MBA application goals</p>
                </div>
    ...
    return (
        <>
            <div className='flex  items-center sm:items-start md:items-start lg:items-start xl:items-start flex-col gap-y-5 w-full '>
                ...
                <p className=' text-[#404040] text-md  text-center sm:text-start md:text-start lg:text-start xl:text-start'>{props.trp_content}</p>
            </div>
        </>
    )
}